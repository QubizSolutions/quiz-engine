...
namespace Qubiz.QuizEngine.UnitTesting.Database
{
    ...
    public class AdminRepositoryTest
    {
        ...
        [TestMethod]
        public async Task GetAllAdminsAsync_AddAdmins_ReturnListOfAdmins()
        {
            /*
            ...
            Admin[] admins = await adminRepository.GetAllAdminsAsync();
        ...
        [TestMethod]
        public async Task GetAllAdminsAsync_AddAdmins_ReturnListOfAdmins2()
        {
            /*
            ...
            Admin[] adminsFromDb = await adminRepository.GetAllAdminsAsync();
        ...
        [TestMethod]
        public async Task AddAdminsAsync_CreateAndAddAdmin_GetAdmin()
        {
            Admin newAdmin1 = new Admin
            {
                ID = Guid.NewGuid(),
        ...
        public async Task GetAdminByNameAsync_CreateAdminAddAdmin_ReturnAdminWithGivenName()
        {
            ...
            Admin adminFoundById = await adminRepository.GetByNameAsync(newAdmin1.Name);
